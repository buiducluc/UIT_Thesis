...
public class Lucene {
	...
	public List<String> SearchSentences(String Question, List<String> Data) throws IOException, ParseException {
		...
		// 2. query
		// extract
		queryString = ParsesQuestion.ExtractQuery(Question);
		System.out.println("Extract reusult: " + queryString);

		String querystr = ParsesQuestion.PatternRepalace(queryString);
		// System.out.println("Repalace result:" + querystr);

		// the "title" arg specifies the default field to use
		// when no field is explicitly specified in the query.
		Query q = new QueryParser("contents", analyzer).parse(ParsesQuestion.QueryParseTitle(querystr, "title") + " OR " + querystr);
...
//		QuestionType = IdentifyQuestion.ClassifyQuestion(input);
